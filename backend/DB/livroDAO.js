...
export default class LivroDAO {
  ...
  async consultar() {
    const conexao = await conectar();
    const sql =
      "SELECT * from Cliente cli INNER JOIN Livro liv ON cli.cli_cpf = liv.cli_cpf order by liv.liv_id ASC";
  ...
  async consultarID(id) {
    ...
    const conexao = await conectar();
    const sql =
      "SELECT * from Cliente cli INNER JOIN Livro liv ON cli.cli_cpf = liv.cli_cpf WHERE liv.liv_id = ? order by liv.liv_id ASC";
  ...
  async consultarPorCliente(cpf) {
    ...
    const conexao = await conectar();
    const sql =
      "SELECT * from Cliente cli INNER JOIN Livro liv ON cli.cli_cpf = liv.cli_cpf WHERE liv.cli_cpf = ? order by liv.liv_id ASC";
